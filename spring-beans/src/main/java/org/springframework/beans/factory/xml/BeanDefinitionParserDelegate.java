...
public class BeanDefinitionParserDelegate {
	...
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele,
		...
		// 如果没有指定 id 则使用 name 属性的第一个值作为 bean name
		String beanName = id;
		...
		if (containingBean == null) { // 顶级 bean 校验 bean name 的唯一性
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(Element ele, String beanName,
		...
		try {
			...
			// 根据 class name 构建 GenericBeanDefinition
	...
	/**
	 * 解析 bean 的各种属性 Apply the attributes of the given bean element to the given bean *
	 * definition.
	 * 
