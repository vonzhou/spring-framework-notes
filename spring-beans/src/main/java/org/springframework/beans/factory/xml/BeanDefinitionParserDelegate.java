...
public class BeanDefinitionParserDelegate {
	...
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele,
		...
		// ���û��ָ�� id ��ʹ�� name ���Եĵ�һ��ֵ��Ϊ bean name
		String beanName = id;
		...
		if (containingBean == null) { // ���� bean У�� bean name ��Ψһ��
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(Element ele, String beanName,
		...
		try {
			...
			// ���� class name ���� GenericBeanDefinition
	...
	/**
	 * ���� bean �ĸ������� Apply the attributes of the given bean element to the given
	 * bean * definition.
	 * 
	...
	/**
	 * 解析元素的某个属性值。用于解析构造函数参数时，propertyName 为空。
	 * <p>
	...
	public Object parsePropertyValue(Element ele, BeanDefinition bd,
		...
		// 出错的配置：同时具有 ref 和 value 属性；存在 ref 或者 value 属性，且有子元素。
		...
		else if (subElement != null) { // 属性值包含在子元素中
	...
	public Object parsePropertySubElement(Element ele, BeanDefinition bd,
		...
		else if (nodeNameEquals(ele, MAP_ELEMENT)) {// 对 map 子元素的处理
	...
	public BeanDefinitionHolder decorateBeanDefinitionIfRequired(Element ele,
		...
		// Decorate based on custom attributes first. 遍历所有的属性，看是否需要装饰
		...
		// Decorate based on custom nested elements. 遍历所有的子节点，看是否装饰
