...
public interface BeanFactory {
	 ...
	 *        the actual class, or {@code null} for any match. For example, if the value
	...
	/**
	 * Return the aliases for the given bean name, if any. All of those aliases point to
	 * the same bean when used in a {@link #getBean} call.
	 * <p>
