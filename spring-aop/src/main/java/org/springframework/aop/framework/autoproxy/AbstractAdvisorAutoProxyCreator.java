 ...
 *
 * <p>
 * Subclasses must implement the abstract {@link #findCandidateAdvisors()} method to
 * return a list of Advisors applying to any object. Subclasses can also override the
 * inherited {@link #shouldSkip} method to exclude certain objects from auto-proxying.
 *
 * <p>
 * Advisors or advices requiring ordering should implement the
 * {@link org.springframework.core.Ordered} interface. This class sorts Advisors by
 * Ordered order value. Advisors that don't implement the Ordered interface will be
 * considered as unordered; they will appear at the end of the advisor chain in undefined
 * order.
 *
 * @author Rod Johnson
...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
	...
	protected void initBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		this.advisorRetrievalHelper = new BeanFactoryAdvisorRetrievalHelperAdapter(
				beanFactory);
	}
	...
	/**
	 * 找到所有候选的 Advisor。 Find all candidate Advisors to use in auto-proxying.
	 * 
	 ...
	 * 
	 * @param candidateAdvisors Advisors that have already been identified as applying to
	 *        a given bean
	 */
